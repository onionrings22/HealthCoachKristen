        ...
        <div id="title-bar">
            ...
            <div id="navigation">
                <ul>
                    ...
                    <a href="pages/faq.php">FAQ</a></li>
                    <li<?php if ($thisPage=="contact") echo " id=\"currentpage\""; ?>>
                    <a href="pages/contact.php">Contact Kristen</a></li>
                    <li<?php if ($thisPage=="goals") echo " id=\"currentpage\""; ?>>
                    <a href="pages/goals.php">My Goals</a></li>
                    ...
                    <a href="pages/login.php">Log in/Sign up</a></li>
                </ul>
            </div>
        </div>